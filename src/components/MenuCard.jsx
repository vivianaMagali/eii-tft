...
const MenuCard = ({ product, orders, setOrders, setShowOrderSummary }) => {
  ...
  return (
    <div class="relative my-5 mx-2 flex w-2/5 h-64 flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
      ...
      <div class="p-6">
        ...
        <div class="flex flex-row items-center justify-between">
          <h3>{product.price}€</h3>
          <div class="left-0 flex flex-row items-center justify-end">
            {quantity !== 0 && (
              <button
