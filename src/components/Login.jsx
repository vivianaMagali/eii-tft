    ...
    return (
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div className="mt-2">
                  ...
                  <div className="mt-2">
                      <div className="relative">
                        ...
                        /> 
                        <button type="button" onClick={showVisible} class="absolute top-0 end-0 p-2.5">
                          {isPasswordVisible ? 
            ...
            {registering ? 
              <> ¿No tienes cuenta?{' '}
                <button type="button" onClick={()=>setRegistering(!registering)} className="font-semibold leading-6 text-teal-600 hover:text-teal-500">
                  Regístrate
                </button> 
              </> : <button type="button" onClick={()=>setRegistering(!registering)} className="font-semibold leading-6 text-teal-600 hover:text-teal-500">
                Inicia sesión
